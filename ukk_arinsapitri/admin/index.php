...
<div class="container mt-2">
  ...
  <div class="search">
        <div class="container">
            <form action="">
                <input type="text" name="search" placeholder="Cari Username"  size="150"/>
  ...
  foto.userid=user.userid INNER JOIN album ON foto.albumid=album.albumid AND user.username LIKE '%$katacari%' ");
